...
var TestCases = []TestCase{
	...
	{Target: "khulnasoft.com", Expected: []string{"khulnasoft.com"}, Args: "-nc"},
	...
	{Target: "khulnasoft.com", Expected: nil, Args: "-resp -nc", CompareFunc: func(target string, got []string) error {
		cdn := "cloudflare"
